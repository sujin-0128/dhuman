...
class DBTableField extends \Bundle\Component\Database\DBTableField
{
	...
	/**
     * [LOG] tableDiscountBundleGroup 기본값
     *
     * @author sjlee
     * @return array tableDiscountBundleGroup 테이블 필드 정보
     */
    public static function tableDiscountBundleGroup()
    {
        // @formatter:off
        $arrField = [
            ['val' => 'groupCd', 'typ' => 's', 'def' => null], // 매핑 모드
            ['val' => 'groupNm', 'typ' => 's', 'def' => null], // 매핑 모드
            ['val' => 'scmNo', 'typ' => 'i', 'def' => null], // 매핑 완료 여부
			['val' => 'groupDescription', 'typ' => 's', 'def' => null], // 매핑 모드
	...
	/**
     * [LOG] tableDiscountBundleGroupGoods 기본값
     *
     * @author sjlee
     * @return array tableDiscountBundleGroupGoods 테이블 필드 정보
     */
    public static function tableDiscountBundleGroupGoods()
    {
        // @formatter:off
        $arrField = [
            ['val' => 'groupCd', 'typ' => 's', 'def' => null], // 매핑 모드
            ['val' => 'goodsNo', 'typ' => 'i', 'def' => null], // 매핑 완료 여부
			['val' => 'bundleType', 'typ' => 's', 'def' => null], // 매핑 완료 여부
			['val' => 'regDt', 'typ' => 's', 'def' => null], // 매핑 모드
			['val' => 'modDt', 'typ' => 's', 'def' => null], // 매핑 모드
        ];
        // @formatter:on
