 ...
 */
class OrderNewPsController extends \Bundle\Controller\Front\Order\OrderPsController
{
    /**
     * {@inheritdoc}
     *
...
//                    }
                    ...
                    if ($click_key != '' && $click_key != null && $goodsNo != '' && $goodsNo != null) {
                        ...
                        $this->db->query("INSERT INTO `es_adInfo` (`orderNo`, `goodsNo`, `adChannel`, `adKey`, `memo`, `result`, `regDt`) VALUES ('".$order->orderNo."', '".$goodsNo."', 'AdiSON', '".$click_key."', 'OrderNewPs', '', now());");
                    }
                    ...
                    $dpx2->dpxAgree($postValue['dpxAgreeInfo'], $order->orderNo);
                    /* designpix 20220304 구매정보 동의 항목추가 */
