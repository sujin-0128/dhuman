 ...
 * @author  su
 */
class LayerCouponApplyOrderController extends \Bundle\Controller\Mobile\Order\LayerCouponApplyOrderController
{
...
//if (\Request::server()->get('REMOTE_ADDR') == "211.254.148.234" || \Request::server()->get('REMOTE_ADDR') == "220.118.145.49" || \Request::server()->get('REMOTE_ADDR') == "121.141.26.134" || \Request::getRemoteAddress() == "121.141.26.133" ){ 
