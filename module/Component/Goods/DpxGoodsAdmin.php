...
class DpxGoodsAdmin extends \Bundle\Component\Goods\GoodsAdmin
{
    ...
    public function getAdminListBatch($mode = null)
    {
        ...
        switch ($mode) {
            ...
            case 'restock':
                ...
                break;
            case 'image' :
                $addField = ", g.useGiftFl, g.benefitUseType, g.newGoodsRegFl, g.newGoodsDate, g.newGoodsDateFl, g.periodDiscountStart, g.periodDiscountEnd, g.fixedGoodsDiscount, g.goodsDiscountGroupMemberInfo";
                break;
            default :
                $addField = '';
        }
    ...
    public function getAdminListGoods($mode = null, $pageNum = 5)
    {
		...
		if($getValue['searchEventFl']=='y'){
			 $this->arrWhere[] = " g.dpxEventFl ='y'";
